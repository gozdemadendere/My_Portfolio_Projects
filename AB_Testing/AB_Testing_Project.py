#####################################################
# A/B Testing ile Bidding (Teklif Verme) Yöntemlerinin Dönüşümünün Karşılaştırılması
#####################################################
...
file_path  = pd.ExcelFile("AB_Testing_Project/AB_Testing.xlsx")
...
df_control = pd.read_excel("AB_Testing_Project/AB_Testing.xlsx", sheet_name='Control Group')
df_test = pd.read_excel("AB_Testing_Project/AB_Testing.xlsx", sheet_name='Test Group')
